    ...
    <nav className="fixed top-0 flex w-full p-6 glass-thick z-30">
      ...
      <div>
        {loading ? (
          ...
          <a
            className="inline-block text-blue-300 no-underline hover:text-pink-500 hover:text-underline text-center md:h-auto transform hover:scale-125 duration-300 ease-in-out"
            href="https://github.com/grumpyTofu"
            target="_blank"
            rel="noreferrer"
          >
            <svg viewBox="0 0 438.549 438.549" className="fill-current h-6 sm:h-8 lg:h-6">
              <g>
